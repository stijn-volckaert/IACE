...
var config string UPackages[32];          // UScript packages to validate (BaseName!)
var config string NativePackages[32];     // Libraries to validate
...
defaultproperties
{
    ...
    bHidden=true
    bAutoConfig=true
    AutoConfigPackage="ACEv09_AutoConfig"
    bSShotWhenKick=true
    SShotQuality=85
    AdminPass=""
